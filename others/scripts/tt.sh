...
#     ../bin/main ../testcase/flower.png ../output2/kmeans_flower_cuda_warp.png kmeans cuda_opt_warp 128


srun -p nvidia -N1 -n1 --gres=gpu:1 \
    nvprof --metrics \
    achieved_occupancy,sm_efficiency,shared_load_throughput,shared_store_throughput,gld_throughput,gst_throughput \
    ../bin/main ../testcase/flower.png ../output2/flower_slic_opt.png slic cuda_opt 10000
...
# srun -p nvidia -N1 -n1 --gres=gpu:1 ../bin/main ../testcase/lion_${it}.png ../output/lion_slic_cudaopt.png slic cuda_opt 10000
